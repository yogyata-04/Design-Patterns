...
- ### *Strategy design pattern* 
  ...
  - Link: https://paritoshdadhich.medium.com/strategy-design-pattern-7e56a15e056b
- ### *Observer design pattern*
  - one-to-many dependency between objects so that when one object changes state, all its dependents are notified automatically
  - Link: https://medium.com/@mokshgoyal666/understanding-the-observer-pattern-in-depth-443c3bc3d15d
